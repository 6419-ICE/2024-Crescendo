...
public class TrajectoryPaths {
    ...
    // Start Putting new Autonomus Trajectories aqui(here), use this entry as an
    // example.
    ...
    //
    // These sets of trajectories are being used to Create the Two Cube Autonomus
    // Program
    // region TwoBlockAuto
    ...
    public static Trajectory trajectoryAutoDriveOutLeft() {
        Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
                ...
                new Pose2d(Units.inchesToMeters(43), Units.feetToMeters(6.00),
    ...
    public static Trajectory trajectoryAutoDriveOutRight() {
        Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
                ...
                // End 14 straight ahead of where we started, facing forward
                new Pose2d(Units.inchesToMeters(41), Units.feetToMeters(-6.0),
                        new Rotation2d(Units.degreesToRadians(0))),
                config);
        return trajectory;
    }
