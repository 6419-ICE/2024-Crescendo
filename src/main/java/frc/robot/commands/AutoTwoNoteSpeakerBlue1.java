...
public class AutoTwoNoteSpeakerBlue1 extends SequentialCommandGroup {
    public AutoTwoNoteSpeakerBlue1(VerticalAimerProfiledPIDSubsystem m_aimer, DriveSubsystem m_drive, IntakeSubsystem m_intake, WristProfiledPIDSubsystem m_wrist, ArmProfiledPIDSubsystem m_arm, LauncherSubsystem m_launcher) {
        addCommands(
            Commands.sequence(
                Commands.parallel(
                    new TrajectoryCommand(m_drive, TrajectoryPaths.getPathWeaverTrajectory("Auto2NS1")),
